...
# Import SQLAlchemy Base and models to ensure they're registered with Base.metadata
...
def run_migrations_online() -> None:
    ...
    connectable = engine_from_config(
        ...
        url=db_url  # Ensure we use the correct DB URL
    )
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            # Add these for better autogenerate support
            render_as_batch=True,  # For SQLite compatibility if needed
            # Add support for enums and other custom types
            user_module_prefix='sa.Enum(',
            dialect_opts={"paramstyle": "named"},
        )
